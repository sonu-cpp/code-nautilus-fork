...
wget -q -O ~/.local/share/nautilus-python/extensions/vscode_extension.py https://raw.githubusercontent.com/sonux2005/code-nautilus-fork/master/vscode_extension.py
